...
public class POIWordFiles {
    public static void main(String[] args) throws Exception {
		...
		while (in2.ready()) {
		    ...
		    if (new File(path + "Tables\\" + name + ".csv").exists()) {
			FileInputStream fstream = new FileInputStream(path + "Tables\\" + name + ".csv");
	        ...
	        String imgFile = path + "\\Images\\" + name + ".gif";
...
//This would imply that this break shall be treated as a simple line break, and break the line after that word:
        ...
        */
        ...
        FileOutputStream out = new FileOutputStream("C:\\Users\\tshaw\\Desktop\\PROTEOMICS\\Mertz\\GenerateReport\\simple.docx");
        doc.write(out);
        out.close();
