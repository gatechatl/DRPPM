...
public class YuxinPOIWordFiles {
    public static void main(String[] args) throws Exception {
        ...
        String path_img = "C:\\Users\\tshaw\\Desktop\\PROTEOMICS\\Mertz\\DEEP\\output_img_raw\\";
        String path_csv = "C:\\Users\\tshaw\\Desktop\\PROTEOMICS\\Mertz\\DEEP\\output_csv_raw\\";
		...
		while (in2.ready()) {
			...
			String geneName = split2[1];
	        
	        //String peptideName = split2[1].replaceAll("\\*", "").split("\\.")[1];
			String peptideName = split2[8];
	        ...
	        String imgFile = path_img + "\\" + name + ".gif";
...
//This would imply that this break shall be treated as a simple line break, and break the line after that word:
        ...
        */
        ...
        FileOutputStream out = new FileOutputStream("C:\\Users\\tshaw\\Desktop\\PROTEOMICS\\Mertz\\DEEP\\Report\\simple.docx");
        doc.write(out);
        out.close();
