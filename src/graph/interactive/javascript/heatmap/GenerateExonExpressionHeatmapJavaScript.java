...
public class GenerateExonExpressionHeatmapJavaScript {
	...
	public static String generate_heatmap_script(int[] row, int[] col, double[] value, String[] row_header, String[] col_header) {
		...
		script.append("  legendElementWidth = 11,\n");
		script.append("  colorBuckets = 11,\n");
		...
		script.append("  colors = ['#0000FF', '#3232FF', '#6464FF', '#9696FF', '#C8C8FF', '#FFFFFF', '#FFC8C8', '#FF9696', '#FF6464', '#FF3232', '#FF0000'];\n");
		...
		script.append("      ;\n");
		script.append("\n");
		script.append("  var menu = contextMenu().items('Load Exon Structure', 'UCSC Genome Browser', 'Check Cohort Information');\n");
		...
		script.append("               selected_exon = rowLabel[d.row-1];\n");
		script.append("        })\n");
		...
		script.append("      .data(['Min','','','','>1QRT','','','','','','Max'])\n");
		...
		script.append("    function contextMenu() {\n");
		script.append("        var height,\n");
		script.append("            width, \n");
		script.append("            margin = 0.1, // fraction of width\n");
		script.append("            items = [], \n");
		script.append("            rescale = false, \n");
		script.append("            style = {\n");
		script.append("                'rect': {\n");
		script.append("                    'mouseout': {\n");
		script.append("                        'fill': 'rgb(244,244,244)', \n");
		script.append("                        'stroke': 'white', \n");
		script.append("                        'stroke-width': '1px'\n");
		script.append("                    }, \n");
		script.append("                    'mouseover': {\n");
		script.append("                        'fill': 'rgb(200,200,200)'\n");
		script.append("                    }\n");
		script.append("                }, \n");
		script.append("                'text': {\n");
		script.append("                    'fill': 'steelblue', \n");
		script.append("                    'font-size': '13'\n");
		script.append("                }\n");
		script.append("            }; \n");
		script.append("        function menu(x, y) {\n");
		script.append("            d3.select('.context-menu').remove();\n");
		script.append("            scaleItems();\n");
		script.append("    \n");
		script.append("            // Draw the menu\n");
		script.append("            d3.select('svg')\n");
		script.append("                .append('g').attr('class', 'context-menu')\n");
		script.append("                .selectAll('tmp')\n");
		script.append("                .data(items).enter()\n");
		script.append("                .append('g').attr('class', 'menu-entry')\n");
		script.append("                .style({'cursor': 'pointer'})\n");
		script.append("                .on('mouseover', function(){ \n");
		script.append("                    d3.select(this).select('rect').style(style.rect.mouseover) })\n");
		script.append("                .on('mouseout', function(){ \n");
		script.append("                    d3.select(this).select('rect').style(style.rect.mouseout) });\n");
		script.append("            \n");
		script.append("            d3.selectAll('.menu-entry')\n");
		script.append("                .append('rect')\n");
		script.append("                .attr('x', x)\n");
		script.append("                .attr('y', function(d, i){ return y + (i * height); })\n");
		script.append("                .attr('width', width)\n");
		script.append("                .attr('height', height)\n");
		script.append("                .style(style.rect.mouseout);\n");
		script.append("            \n");
		script.append("            d3.selectAll('.menu-entry')\n");
		script.append("                .append('text')\n");
		script.append("                .text(function(d){ return d; })\n");
		script.append("                .attr('x', x)\n");
		script.append("                .attr('y', function(d, i){ return y + (i * height); })\n");
		script.append("                .attr('dy', height - margin / 2)\n");
		script.append("                .attr('dx', margin)\n");
		script.append("                .style(style.text)\n");		
		script.append("                .on('click', function(d, i) {\n");		
		script.append("     	       ;\n");
		script.append("    	       if (d == \"UCSC Genome Browser\") {\n");
		script.append("                       //var rowtext=d3.select('.r'+(d.row-1));\n");
		script.append("    	           //document.write(selected_exon);\n");
		
		script.append("    	           var split = selected_exon.replace(\"_ECM_\", \"_\").split(\"_\");\n");
		script.append("    	           var chr = split[1];\n");
		script.append("        	           var start = split[2];\n");
		script.append("    	           var end = split[3];\n");
		script.append("    	           var url = \"http://genome.ucsc.edu/cgi-bin/hgTracks?db=hg38&position=\" + chr + \"%3A\" + start + \"-\" + end;\n");
		script.append("    	           window.open(url);\n");
		script.append("    \n");
		script.append("    	       }\n");
		script.append("    	    });\n");				
		script.append("            // Other interactions\n");
		script.append("            d3.select('body')\n");
		script.append("                .on('click', function() {\n");
		script.append("                    d3.select('.context-menu').remove();\n");
		script.append("                });\n");
		script.append("    \n");
		script.append("        }\n");
		script.append("        \n");
		script.append("        menu.items = function(e) {\n");
		script.append("            if (!arguments.length) return items;\n");
		script.append("            for (i in arguments) items.push(arguments[i]);\n");
		script.append("            rescale = true;\n");
		script.append("            return menu;\n");
		script.append("        }\n");
		script.append("    \n");
		script.append("        // Automatically set width, height, and margin;\n");
		script.append("        function scaleItems() {\n");
		script.append("            if (rescale) {\n");
		script.append("                d3.select('svg').selectAll('tmp')\n");
		script.append("                    .data(items).enter()\n");
		script.append("                    .append('text')\n");
		script.append("                    .text(function(d){ return d; })\n");
		script.append("                    .style(style.text)\n");
		script.append("                    .attr('x', -1000)\n");
		script.append("                    .attr('y', -1000)\n");
		script.append("                    .attr('class', 'tmp');\n");
		script.append("                var z = d3.selectAll('.tmp')[0]\n");
		script.append("                          .map(function(x){ return x.getBBox(); });\n");
		script.append("                width = d3.max(z.map(function(x){ return x.width; }));\n");
		script.append("                margin = margin * width;\n");
		script.append("                width =  width + 2 * margin;\n");
		script.append("                height = d3.max(z.map(function(x){ return x.height + margin / 2; }));\n");
		script.append("                \n");
		script.append("                // cleanup\n");
		script.append("                d3.selectAll('.tmp').remove();\n");
		script.append("                rescale = false;\n");
		script.append("            }\n");
		script.append("        }\n");
		script.append("    \n");
		script.append("        return menu;\n");
		script.append("    }\n");
		script.append("      var selected_exon = \"NA\";\n");
		...
		script.append("      .on('contextmenu', function(){ \n");
		script.append("                 d3.event.preventDefault();\n");
		script.append("                 //d3.selectAll('.rowLabel').classed('text-selected',false);\n");
		script.append("                 //d3.selectAll('.colLabel').classed('text-selected',false);	    \n");
		script.append("                var p = d3.mouse(this);\n");
		script.append("                   sa.append('rect')\n");
		...
		script.append("                 })\n");
		script.append("    	\n");
		script.append("                 menu(d3.mouse(this)[0] + margin.left, d3.mouse(this)[1] + margin.top);\n");
		script.append("          });\n");
