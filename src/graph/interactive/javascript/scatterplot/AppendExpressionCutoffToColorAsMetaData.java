 ...
 *
 */
public class AppendExpressionCutoffToColorAsMetaData {
	...
	public static String parameter_info() {
		return "[matrixFile] [geneExpressionMatrix] [geneName] [cutoff for positive and negative] [takeLog boolean] [outputMatrixWithColor]";
	}
	public static void execute(String[] args) {
		...
		try {
			...
			double cutoff = new Double(args[3]); // from 1 to 100 previously I used 75
