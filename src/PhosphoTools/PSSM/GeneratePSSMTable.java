 ...
 *
 */
public class GeneratePSSMTable {

	public static String type() {
		return "PSSM";
	}
	public static String description() {
		return "PSSM Motif Finder";
	}
	public static String parameter_info() {
		return "[fastaFile] [path] [pssmFile] [outputPath]";
	}
	public static void execute(String[] args) {
		...
		try {
			...
			HashMap backFreq = getBackgroundFrequency(buffer.toString());
			...
			//File f = new File("C:\\Users\\tshaw\\Desktop\\PROTEOMICS\\Projects\\Kundu\\KnownULK1Sites\\Input");
			File f = new File(path);
			for (File file_fasta: f.listFiles()) {
				if (file_fasta.getName().contains("fasta")) {
					String fileName = file_fasta.getName().replace(".fasta", "");
					inputFile = file_fasta.getPath(); //"C:\\Users\\tshaw\\Desktop\\PROTEOMICS\\Projects\\Kundu\\KnownULK1Sites\\Input\\" + fileName + ".fasta"; //args[0];
					//inputFile = "C:\\Users\\tshaw\\Desktop\\PROTEOMICS\\Projects\\Kundu\\ULK1_CLASP1-2_Project\\Convert2fasta\\" + fileName + ".fasta"; //args[0];
					//String pssmFile = "C:\\Users\\tshaw\\Desktop\\PROTEOMICS\\Projects\\Kundu\\ULK1_pssm_20151021.txt"; // args[1];			
					//String pssmFile = "C:\\Users\\tshaw\\Desktop\\PROTEOMICS\\Projects\\Kundu\\ULK1_pssm_junmin.txt"; // args[1];
					//String outputFile = "C:\\Users\\tshaw\\Desktop\\PROTEOMICS\\Projects\\Kundu\\ULK1_CLASP1-2_Project\\output\\" + fileName + ".output"; //args[0];
					//String outputFile = "C:\\Users\\tshaw\\Desktop\\PROTEOMICS\\Projects\\Kundu\\KnownULK1Sites\\Output\\" + fileName + ".output"; //args[0];
					String outputFile = outputPath + "/" + fileName + ".output";
					HashMap map = new HashMap();
					...
					while (itr.hasNext()) {
						...
						for (int i = 0; i <= seq.length() - 10; i++) {
							...
							if (substring.substring(5, 6).equals("S") || substring.substring(5, 6).equals("T")) {
								...
								out.write(id + "\t" + phosphosite_aa + (i + 6) + "\t" + substring + "\t" + pssm_scoring(substring, pssm, array, backFreq) + "\n");
								id++;
							}					
						}
					}
