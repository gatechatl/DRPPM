...
/**
 * Normalize the matrix for IKAP input with user specifying the number of samples
 * @author tshaw
 *
 */
public class NormalizeMatrix2IKAPFlex {
	...
	public static String parameter_info() {
		return "[inputPhosphoFile] [index] [factor] [NumberOfSamples] [outputFile]";
	}
	public static void execute(String[] args) {
		...
		try {
			...
			while (in.ready()) {
				...
				String kinase = split[numSamples + 1].toUpperCase();
