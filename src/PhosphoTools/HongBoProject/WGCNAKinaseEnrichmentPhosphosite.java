 ...
 *
 */
public class WGCNAKinaseEnrichmentPhosphosite {
	...
	public static void execute(String[] args) {
		...
		try {
			...
			while (itr.hasNext()) {
				...
				int a = hit;
				int b = totalKinase - hit;
				int c = diff - hit;
				int d = total - b - c;
				
				double enrichment_value = (hit / diff) / (totalKinase / total); 
				double fisher_pvalue = MathTools.fisherTest(a, b, c, d);
				double corrected_fisher_pvalue = fisher_pvalue * kinase_map.size();
