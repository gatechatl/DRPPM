	...
	public static void execute(String[] args) {
		...
		try {
			...
			while (in.ready()) {
				...
				out2.write("samtools view -u -f 1 -F 12 " + file + " -o " + sampleName + "_map_map.bam\n");
				out2.write("samtools view -u -f 4 -F 264 " + file + " -o " + sampleName + "_unmap_map.bam\n");
				out2.write("samtools view -u -f 8 -F 260 " + file + " -o " + sampleName + "_map_unmap.bam\n");
				out2.write("samtools view -u -f 12 -F 256 " + file + " -o " + sampleName + "_unmap_unmap.bam\n");
				...
				out2.write("samtools sort -n " + sampleName + "_map_map.bam -O bam -o " + sampleName + "_mapped.sort.bam -T " + sampleName + "_mapped.sort.bam.tmp\n");
				out2.write("samtools sort -n " + sampleName + "_unmapped.bam -O bam -o " + sampleName + "_unmapped.sort.bam -T " + sampleName + "_unmapped.sort.bam.tmp\n");
