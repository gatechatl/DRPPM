...
public class FilterORAResults {
	...
	public static String parameter_info() {
		return "[inputFDRFile] [pval_cutoff] [fdr_cutoff] [outputFile] [UpRegOutputFile] [DnRegOutputFile]";
	}
	public static void execute(String[] args) {
		...
		try {
			...
			String upreg_outputFile = args[4];
			String dnreg_outputFile = args[5];
