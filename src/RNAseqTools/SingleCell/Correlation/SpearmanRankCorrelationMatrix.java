package RNAseqTools.SingleCell.Correlation;
...
public class SpearmanRankCorrelationMatrix {
	...
	public static String parameter_info() {
		return "[inputFile] [referenceFile] [cutoff] [correlationMatrix]";
	}
	public static void execute(String[] args) {
		...
		try {
			...
			String correlationMatrix = args[3];
