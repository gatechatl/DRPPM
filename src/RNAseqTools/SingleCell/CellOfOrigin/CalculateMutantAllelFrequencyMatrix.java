...
/**
 * Take variant matrix and calculate the mutant allele % matrix
 * @author tshaw
 *
 */
public class CalculateMutantAllelFrequencyMatrix {
	public static String type() {
		return "SNV";
	}
	public static String description() {
		return "Take variant matrix and calculate the mutant allele % matrix";
	}
	public static String parameter_info() {
		return "[snvTableMatrix]";
	}
