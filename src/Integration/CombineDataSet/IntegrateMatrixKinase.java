 ...
 *
 */
public class IntegrateMatrixKinase {
	...
	public static void main(String[] args) {
		try {
			...
			//String kinaseListFile = "C:\\Users\\tshaw\\Desktop\\PROTEOMICS\\Projects\\HonboChi\\Paper's Figures\\Figure4_20160317\\Transcription_Factor_List.txt";
			...
			//String outputFile = "C:\\Users\\tshaw\\Desktop\\PROTEOMICS\\Projects\\HonboChi\\Paper's Figures\\Figure4_20160317\\TFInformation.txt";
				...
				if (map.containsKey(kinase.toUpperCase())) {
					...
					if (protein2peptide.containsKey(protein_name)) {
						...
						while (itr3.hasNext()) {
							...
							String phospho_line = (String)phosphoData.get(peptide);
