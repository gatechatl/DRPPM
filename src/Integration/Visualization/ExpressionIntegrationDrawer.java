 ...
 *
 */
public class ExpressionIntegrationDrawer {
	...
	public static String parameter_info() {
		return "[whl_inputFile] [pho_inputFile] [kinase_inputFile] [groups] [ZscoreBorder] [ouputPath]";
	}
	...
	public static void execute(String[] args) {
		...
		try {
			...
			double range = new Double(args[4]);
