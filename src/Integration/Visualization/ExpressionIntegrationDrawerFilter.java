 ...
 *
 */
public class ExpressionIntegrationDrawerFilter {
	...
	public static void execute(String[] args) {
		...
		try {
			...
			String filterFile = args[3];
			String[] groups = args[4].split(":");
			double range = new Double(args[5]);
			...
			while (in.ready()) {
				...
				if (validGene.containsKey(split[0].split("_")[0].toUpperCase())) {
			...
			in.close();
			System.out.println("pho_zscores_map.size(): " + pho_zscores_map.size());
