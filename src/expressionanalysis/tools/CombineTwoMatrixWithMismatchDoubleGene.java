 ...
 *
 */
public class CombineTwoMatrixWithMismatchDoubleGene {
	

	public static String description() {
		return "Combinwo gene matrix file together (first two column are genes), if genename doesn't match will put NAs";
	}
	...
	public static void execute(String[] args) {
		...
		try {
			...
			while (in.ready()) {
				...
				comprehensive.put(split[0] + "\t" + split[1], split[0] + "\t" + split[1]);
			}
			in.close();
