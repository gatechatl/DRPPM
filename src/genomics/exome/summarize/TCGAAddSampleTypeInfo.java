...
public class TCGAAddSampleTypeInfo {
	...
	public static void main(String[] args) {
		...
		try {
			...
			String inputFile = "C:\\Users\\tshaw\\Desktop\\EXONCAP\\McKinnon\\MutantAllelePlots\\SJHGG\\cosmic";
			//String sampleFile = "C:\\Users\\tshaw\\Desktop\\EXONCAP\\McKinnon\\MutantAllelePlots\\SJHGG\\samples.txt";
			String outputFile = "C:\\Users\\tshaw\\Desktop\\EXONCAP\\McKinnon\\MutantAllelePlots\\SJHGG\\tcga_output.txt";
			
			String outputFile2 = "C:\\Users\\tshaw\\Desktop\\EXONCAP\\McKinnon\\MutantAllelePlots\\SJHGG\\tcga_output_averageTypefrequency.txt";
			String outputFile3 = "C:\\Users\\tshaw\\Desktop\\EXONCAP\\McKinnon\\MutantAllelePlots\\SJHGG\\tcga_output_TsTv.txt";
			...
			*/
			...
			while (in.ready()) {
				...
				String sampleName = split[8];
				
				//String ref_allele = split[10];
				//String mut_allele = split[11];
				String ref_allele = split[split.length - 2];
				String mut_allele = split[split.length - 1];				
				...
				if (split[2].equals("SILENT")) {
					System.out.println(mut_type);
					String sampleType = "TCGA";
