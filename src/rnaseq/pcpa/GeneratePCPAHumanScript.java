 ...
 *
 */
public class GeneratePCPAHumanScript {
	...
	public static void execute(String[] args) {
		try {
			...
			while (in.ready()) {
				...
				out.write(step11_polyA_dist(sample, coverageBedPath, perlPath) + "\n");
	...
	public static String step11_polyA_dist(String sample, String coverageBedPath, String perlPath) {
