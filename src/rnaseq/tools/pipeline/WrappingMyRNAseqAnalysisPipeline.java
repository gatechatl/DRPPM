				...
				if (bam_path_map.containsKey(sampleName)) {
					...
					if ((new File(bam_file_path)).exists() || remapping || type.equalsIgnoreCase("FASTQ")) {
						...
						if (!SKIP_HTSEQ_EXON_QUANT) {
							...
							out_OUTPUT_HTSEQEXON_FILELST.write(sampleName + "\t" + outputFolder + "/" + sampleName + "/htseq_exon_level/" + sampleName + ".exon.htseq.fpkm.txt" + "\t" + outputFolder + "/" + sampleName + "/htseq_exon_level/" + sampleName + ".exon.htseq.count.txt" + "\t" + outputFolder + "/" + sampleName + "/htseq_exon_level/" + sampleName + ".htseq.total.count.txt" + "\n");
