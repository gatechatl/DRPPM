...
public class WrappingMyRNAseqAnalysisPipeline {
		...
		try {
			...
			if (remapping) {
				...
				while (itr.hasNext()) {
					...
					if (bam_path_map.containsKey(sampleName)) {
						...
						fq1_path_map.put(sampleName, current_working_dir + "/" + fastq_folder + "/" + sampleName + ".R1.fastq");
			...
			while (itr.hasNext()) {			
				...
				if (fq1_path_map.containsKey(sampleName)) {
					...
					if (fq1_path_map.containsKey(sampleName)) {
						...
						string_buffer.append("fastqc " + fq1_path + " -o " + fastqc_intermediate_folder + "\n");
					}
					if (fq2_path_map.containsKey(sampleName)) {
						...
						string_buffer.append("fastqc " + fq2_path + " -o " + fastqc_intermediate_folder + "\n");
					}
			...
			while (itr.hasNext()) {
				...
				if (fq1_path_map.containsKey(sampleName)) {
					...
					String sampleName_fq_star_lst = outputIntermediateFolder + "/star/" + sampleName + "_star_file.lst";
					...
					out_sampleName_fq_star_lst.write(sampleName + "\t" + fq1 + "\t" + fq2 + "\n");
					...
					string_buffer.append("cp -r " + outputIntermediateFolder + "/star/" + " " + outputFolder + "/star/\n");
	...
	public static String rseqc(String sampleName, String bam_file, String chrNameLengthFile, String houseKeepingGenebed, String refseq_bed, String ribosome_bed) {
		String script = "";
