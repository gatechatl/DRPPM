package rnaseq.tools.singlecell.cnv;
...
public class GenerateRNAseqCNVValuesMouse {
	...
	public static String parameter_info() {
		return "[inputMatrix] [inputGTFFile] [outputFileReorderedMatrix] [outputRoughtAverage] [log? true/false]";
	}
