 ...
 *
 */
public class JuncSalvagerCombine3primePSIMatrixIndex {
			...
			while (in.ready()) {
				...
				if (f.exists()) {
					...
					while (in_psi.ready()) {
						...
						if (new Double(split_psi[split_psi.length - 1]) == 0.0 || new Double(split_psi[split_psi.length - 2]) == 0.0 || (new Double(split_psi[split_psi.length - 1]) + new Double(split_psi[split_psi.length - 2]) < 10)) {
						...
						out.write("\t" + split_psi[split_psi.length - 5].replaceAll("NaN", replaceNaNwithThis));
					}
					in_psi.close();
					out.write("\n");
				}
			...
			while (in.ready()) {
				...
				if (f.exists()) {
					...
					while (in_psi.ready()) {
						...
						if (!black_list_index.containsKey(idx)) {
							String exon = split_psi[0] + "_" + split_psi[1] + "_" + split_psi[2];							
							out_final.write("\t" + split_psi[split_psi.length - 5].replaceAll("NaN", replaceNaNwithThis));
						}
						idx++;
					}
					in_psi.close();
