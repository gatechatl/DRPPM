		...
		try {
			...
			while (in.ready()) {
				...
				if (f.exists()) {
					...
					out.write("drppm -JuncSalvagerExonSkippingPSIClean " + str + " " + gtfFile + " 5 " + outputFolder + "/" + f.getName() + ".pso.clean.txt" + " " + outputFolder + "/" + f.getName() + ".psi.clean.txt true" + "\n");
					out.write("drppm -JuncSalvager5prime3primeUsagePSIClean " + str + " " + gtfFile + " 3 " + outputFolder + "/" + f.getName() + ".PSI_5_prime_alt_spice.clean.txt " + outputFolder + "/" + f.getName() + ".PSI_3_prime_alt_spice.clean.txt true" + "\n");
