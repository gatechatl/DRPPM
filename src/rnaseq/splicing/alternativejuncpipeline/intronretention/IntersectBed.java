...
public class IntersectBed {
	...
	public static String generateScript(String inputFile1, String intronBed, String exonBed, String geneBed) {
		...
		while (itr.hasNext()) {
			...
			script += "intersectBed -a " +  bedFile + " -b " + intronBed + " -sorted > " + bedFile + "_intron.bed \n";
			script += "intersectBed -a " +  bedFile + " -b " + exonBed + " -sorted > " + bedFile + "_exon.bed \n";
			script += "intersectBed -a " +  bedFile + " -b " + geneBed + " -sorted > " + bedFile + "_gene.bed \n";
		}
		return script;
	}
