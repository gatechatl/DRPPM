...
public class SummarizeRMATS402SDResultWithBlackListRelaxed {
	...
	public static void execute(String[] args) {
		...
		try {
			...
			while (in.ready()) {
				...
				if (fdr < 0.2 && !black_list.containsKey(gene)) {
					SD_IR_count++;
					all_gene.put(gene, gene);
			...
			System.out.println("SD_increased_RI_map List:\t" + map2string(SD_increased_RI_map));
			System.out.println("SD_decreased_RI_map List:\t" + map2string(SD_decreased_RI_map));
