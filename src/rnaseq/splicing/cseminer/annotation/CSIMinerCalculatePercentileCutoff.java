...
/**
 * Calculate the percentiles for each sample. These will be used to gauge the cutoffs for quartile low med-low med-high high.
 * @author tshaw
 *
 */
public class CSIMinerCalculatePercentileCutoff {
