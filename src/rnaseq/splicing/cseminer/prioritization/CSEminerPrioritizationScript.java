...
public class CSEminerPrioritizationScript {
	...
	public static String description() {
		return "Perform CSEminer Prioritization of the exons.";
	}
	public static String parameter_info() {
		return "[Comprehensive_Exon_Annotations] [Exon_AS_Annotation] [gencode.v35.primary_assembly.annotation.gtf] [outputExonAnnotationFile]";
	}
	public static void execute(String[] args) {
		...
		try {
			...
			String gtfFilePath = args[1];
			String outputexonFile = args[2];			
			...
			gtfFile.initialize(gtfFilePath);
			...
			FileWriter fwriter_exon = new FileWriter(outputexonFile);
