 ...
 *
 */
public class RNApegPostProcessingExons {

	public static String type() {
		return "RNApeg";
	}
	public static String description() {
		return "RNApeg result: junctions.tab.shifted.tab.annotated.tab.cross_sample_corrected.tab\n";
	}
	...
	public static void execute(String[] args) {
		...
		try {
			...
			String rnapeg_file = inputRNApegFile;
			
			HashMap all_junction = new HashMap();
			FileInputStream fstream2 = new FileInputStream(rnapeg_file);
