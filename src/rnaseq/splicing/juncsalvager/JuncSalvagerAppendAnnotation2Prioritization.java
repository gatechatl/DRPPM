 ...
 *
 */
public class JuncSalvagerAppendAnnotation2Prioritization {


	public static String description() {
		return "Append the annotation information for prioritization";
	}
	public static String type() {
		return "DATAMATRIX";
	}
	public static String parameter_info() {
		return "[inputMatrixCoreFile] [inputTherapeuticFile] [inputSurfaceomeFile] [inputGTExAnnotationFile] [meta_analysis_inputFile] [outputFile]";
	}
	public static void execute(String[] args) {
		...
		try {
			...
			String inputMatrixCoreFile = args[0]; //"\\\\gsc.stjude.org\\project_space\\zhanggrp\\AltSpliceAtlas\\common\\references\\extra_cellular_matrix\\matrixdb_CORE.tab";
			String inputTherapeuticFile = args[1]; //"\\\\gsc.stjude.org\\project_space\\zhanggrp\\AltSpliceAtlas\\common\\references\\therapeutic_targets\\therpeutic_target.txt";
			String inputSurfaceomeFile = args[2]; //"\\\\gsc.stjude.org\\project_space\\zhanggrp\\AltSpliceAtlas\\common\\references\\surfaceome\\pnas\\experiment.txt";
			String meta_analysis_inputFile = args[3]; //"\\\\gsc.stjude.org\\project_space\\zhanggrp\\AltSpliceAtlas\\common\\analysis\\Comprehensive_CAR-T_Analysis\\hg38_full_exon_analysis\\exon_meta_analysis_20200720.txt";
