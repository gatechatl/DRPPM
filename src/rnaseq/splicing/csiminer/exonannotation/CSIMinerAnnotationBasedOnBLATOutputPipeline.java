 ...
 *
 */
public class CSIMinerAnnotationBasedOnBLATOutputPipeline {
	...
	public static String description() {
		return "Append the blat annotation.";
	}
	public static String parameter_info() {
		return "[inputExonAnnotation] [inputBLATSearchResult] [outputFile]";
	}
	...
	public static void execute(String[] args) {
		...
		try {
			...
			String inputExonAnnotation = args[0]; //"/Users/4472414/References/genome/Exon_Annotation/exon_annotation_updated.txt"; 
			
			
			String inputBLATSearchResult = args[1]; //"/Users/4472414/References/genome/Exon_Annotation/output.txt";
