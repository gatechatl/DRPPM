...
public class Bam2FqMouseERCC {

	public static String type() {
		return "MISC";
	}
	public static String description() {
		return "Convert bam 2 fq";
	}
	...
	public static String getSTAR(String fq1, String fq2, String outputFolder) {
		return "/home/tshaw/RNASEQ/Tools/STAR-master/bin/Linux_x86_64_static/STAR --outSAMstrandField intronMotif --genomeDir /nfs_exports/apps/internal/rnaseq/tshaw/STAR_Index/mm9_STAR/star-genome-mm9-ercc/ --readFilesIn " + fq1 + " " + fq2 + " --genomeLoad NoSharedMemory --runThreadN 8 --chimSegmentMin 20 --chimJunctionOverhangMin 20 --outFileNamePrefix " + outputFolder + " --outSAMunmapped Within --outSAMtype BAM SortedByCoordinate";
	}
}
