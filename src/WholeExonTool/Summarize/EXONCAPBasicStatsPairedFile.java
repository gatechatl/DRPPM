...
public class EXONCAPBasicStatsPairedFile {

	public static String type() {
		return "EXONCAP";
	}
	public static String description() {
		return "Calculate the basic statistics for the EXONCAP";
	}
	public static String parameter_info() {
		return "[inputFile] [sampleFile] [mutType] [qualityType] [outputStatTable] [outputMutType1] [outputMutType2] [outputMutType3] [outputMutType4]";
	}
	...
	public static void generateMutTypeFiles(String inputFile, String sampleFile, String muttype, String output1, String output2, String output3, String output4) {
		...
		try {
			...
			while (in.ready()) {
				...
				String sampleName = split[0];
				String ref_allele = split[15];
				String mut_allele = split[16];
				
				String mut_type = ref_allele + "->" + mut_allele;
				String ref_mut = mut_type;
				...
				if (split[2].contains("SJHQ") && (split[6].toUpperCase().equals(muttype.toUpperCase()) || muttype.toUpperCase().equals("ALL"))) {
