package WholeExonTool.SJSNVIndelPipeline;
 ...
 *
 */
public class GenerateGRCh37liteSNVIndelScript {
	...
	public static String create_high20_script(String tumorBam, String germlineBam, String outputDir, String sampleName) {
		return "sh /home/tshaw/EXONCAP/Tools/snp_high_20_tn.sh /nfs_exports/genomes/1/Homo_sapiens/GRCh37-lite/NIB/ /nfs_exports/genomes/1/Homo_sapiens/Hg19/SUPPORT/dbsnp_binary_v2.blob " + tumorBam + " " + germlineBam + " " + " " + outputDir + " " + sampleName + ".high_20.out normal";
	}
	public static String create_low_script(String tumorBam, String germlineBam, String outputDir, String sampleName) {
		return "sh /home/tshaw/EXONCAP/Tools/snp_low_tn.sh /nfs_exports/genomes/1/Homo_sapiens/GRCh37-lite/NIB/ " + tumorBam + " " + germlineBam + " " + outputDir + " " + sampleName + ".low.out normal";
	}
	public static String create_germline_script(String germlineBam, String outputDir, String sampleName) {
		return "sh /home/tshaw/EXONCAP/Tools/snp_germline.sh /nfs_exports/genomes/1/Homo_sapiens/GRCh37-lite/NIB/ /nfs_exports/genomes/1/Homo_sapiens/Hg19/SUPPORT/dbsnp_binary_v2.blob " + germlineBam + " " + " " + outputDir + " " + sampleName + ".germline.out normal";
	}
}
