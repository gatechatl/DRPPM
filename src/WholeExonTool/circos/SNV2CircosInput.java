			...
			while (in.ready()) {
				...
				if (!split[0].equals("GeneName")) {
					...
					if (type.equals("silent")) {
						color = "green";
					} else if (type.equals("missense") || type.equals("nonsense")) {
						color = "black";
					} else {
						color = "blue";
					}
					...
					if (split[1].equals("SJHQ") && split[2].equals(sampleName) && tumorReads >= 5 && (tumorReads / normReads) >= 0.1) {
