 ...
 *
 */
public class CalculateResidueMotifBootstrapDE {
	...
	public static void execute(String[] args) {
		...
		try {
			...
			String[] random_residues = {"D", "E", "R", "H", "K", "S", "T", "N", "Q", "C", "U", "G", "P", "A", "V", "I", "L", "M", "F", "Y", "W"};
			//String[] random_residues = {"D", "E"};
			
			HashMap map_combination = new HashMap();
			//String orig_residues = "D,E,F,Y,W";
			for (String res1: random_residues) {
				for (String res2: random_residues) {
			//		for (String res3: random_residues) {
						if (!res1.equals(res2)) {
							String residues = res1 + "," + res2;
