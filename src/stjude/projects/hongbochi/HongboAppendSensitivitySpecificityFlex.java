...
public class HongboAppendSensitivitySpecificityFlex {

	public static String parameter_info() {
		return "[inputComprehensiveFile] [scoreIndexInComprehensiveFile] [MTORC_Sensitivity_Specificity]";
	}
	...
	public static void execute(String[] args) {
		...
		try {
			...
			int scoreIndex = new Integer(args[1]);
			String MTORC1_sensitivity_specificity = args[2];
			...
			while (in.ready()) {
				...
				String[] split = str.split("\t");
				String line = str;
				double score = new Double(split[scoreIndex]);
				score = new Double(Math.round(score * 10)) / 10;
