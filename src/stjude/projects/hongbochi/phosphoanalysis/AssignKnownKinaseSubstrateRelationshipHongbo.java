 ...
 *
 */
public class AssignKnownKinaseSubstrateRelationshipHongbo {

	public static String description() {
		return "Assign kinase substrate relationship to customized matrix from yuxin";
	}
	public static String type() {
		return "KINASEACTIVITY";
	}
	public static String parameter_info() {
		return "[inputJUMPqSiteFile] [phosphosite_kinsub_file] [outputJUMPqFile]";
	}
	public static void execute(String[] args) {
		...
		try {
			...
			*/
			//out2.write("Phosphosite\tData1\tData2\tData3\tData4\tData5\tData6\tData7\tData8\tData9\tData10\tKINASE\n");
