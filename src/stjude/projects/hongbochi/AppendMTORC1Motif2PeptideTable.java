 ...
 *
 */
public class AppendMTORC1Motif2PeptideTable {
	...
	public static String parameter_info() {
		return "[mTORC1MotifScoreFile] [raptorSubstrateFile] [geneNameIndex: {4}] [accessionIndex: {2}] [siteIndex {14}] [outputFile]";
	}
	public static void execute(String[] args) {
		...
		try {
			...
			fstream = new FileInputStream(peptideFile);
