...
public class LeventakiAppendGeneInfoTumorNormal {
	...
	public static void main(String[] args) {
		...
		try {
			...
			String outputFile = "T:\\Computational Biology\\Timothy Shaw\\HPC_Migration_Temporary\\Leventaki\\common\\Report\\Biostats\\Methylation\\TumorVsNormalLeventaki_850K_methylation_table_WilcoxResult_CandidateTable.txt";
			FileWriter fwriter = new FileWriter(outputFile);
			BufferedWriter out = new BufferedWriter(fwriter);
			
			String inputFile = "T:\\Computational Biology\\Timothy Shaw\\HPC_Migration_Temporary\\Leventaki\\common\\Report\\Biostats\\Methylation\\TumorVsNormalLeventaki_850K_methylation_table_WilcoxResult_0.01_cutoff.txt";
