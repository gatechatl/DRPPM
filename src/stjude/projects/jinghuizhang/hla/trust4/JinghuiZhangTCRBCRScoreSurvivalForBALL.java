...
public class JinghuiZhangTCRBCRScoreSurvivalForBALL {
	...
	public static void main(String[] args) {
		...
		try {
			...
			String inputPatientFile = "Z:\\ResearchHome\\ProjectSpace\\zhanggrp\\AltSpliceAtlas\\common\\analysis\\ImmuneSignatureAnalysis_Updated_Matrix_20200518\\Survival_Analysis\\SJBALL_TARGET\\TARGET_BALL_Patient_Metadata.txt";			
			...
			String outputFile = "Z:\\ResearchHome\\ProjectSpace\\zhanggrp\\AltSpliceAtlas\\common\\analysis\\ImmuneSignatureAnalysis_Updated_Matrix_20200518\\Survival_Analysis\\SJBALL_TARGET\\TARGET_BALL_Patient_Metadata_TCRBCR.txt";
			FileWriter fwriter = new FileWriter(outputFile);
			BufferedWriter out = new BufferedWriter(fwriter);

			String outputFile_script = "Z:\\ResearchHome\\ProjectSpace\\zhanggrp\\AltSpliceAtlas\\common\\analysis\\ImmuneSignatureAnalysis_Updated_Matrix_20200518\\Survival_Analysis\\SJBALL_TARGET\\tcr_bcr_script.r";
			...
			while (itr.hasNext()) {
				...
				out_script.write("write(paste('" + feature + "', 'OS',pval, sep=\" \"), file = \"\\\\\\\\gsc.stjude.org\\\\project_space\\\\zhanggrp\\\\AltSpliceAtlas\\\\common\\\\analysis\\\\ImmuneSignatureAnalysis_Updated_Matrix_20200518\\\\Survival_Analysis\\\\SJBALL_TARGET\\\\TCR_BCR_output.txt\", append = TRUE)\n\n");
				out_script.write("res.cox_ball <- coxph(Surv(Event_Free_Survival_Time_in_Days, First_Event == \"Relapse\") ~ " + feature + ", data = data_ball)\n");
				out_script.write("pval = summary(res.cox_ball)$logtest[3]\n");
				out_script.write("write(paste('" + feature + "', 'First_Event_Relapse',pval, sep=\" \"), file = \"\\\\\\\\gsc.stjude.org\\\\project_space\\\\zhanggrp\\\\AltSpliceAtlas\\\\common\\\\analysis\\\\ImmuneSignatureAnalysis_Updated_Matrix_20200518\\\\Survival_Analysis\\\\SJBALL_TARGET\\\\TCR_BCR_output.txt\", append = TRUE)\n\n");
			...
			while (in.ready()) {
				...
				if (patient2sjid.containsKey(patient_id)) {
					...
					if (sampleNames.containsKey(sjid) && sjid.contains("SJBALL")) {
