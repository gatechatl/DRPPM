...
/**
 * Calculate the percentiles for each sample. These will be used to gauge the cutoffs for low medium high.
 * @author tshaw
 *
 */
public class JinghuiZhangCalculatePercentileCutoff {
