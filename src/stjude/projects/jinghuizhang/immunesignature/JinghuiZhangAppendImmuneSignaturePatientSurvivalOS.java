...
public class JinghuiZhangAppendImmuneSignaturePatientSurvivalOS {
	...
	public static void main(String[] args) {
		...
		try {
			...
			String outputFile = "Z:\\ResearchHome\\ProjectSpace\\zhanggrp\\AltSpliceAtlas\\common\\analysis\\ImmuneSignatureAnalysis\\Survival_Analysis\\SJOS_TARGET\\TARGET_OS_Patient_Metadata_ImmuneSubtype.txt";
			FileWriter fwriter = new FileWriter(outputFile);
			BufferedWriter out = new BufferedWriter(fwriter);

			inputPatientFile = "Z:\\ResearchHome\\ProjectSpace\\zhanggrp\\AltSpliceAtlas\\common\\analysis\\ImmuneSignatureAnalysis\\Survival_Analysis\\SJOS_TARGET\\TARGET_OS_Patient_Metadata.txt";			
			fstream = new FileInputStream(inputPatientFile);
			din = new DataInputStream(fstream);
			in = new BufferedReader(new InputStreamReader(din));
			header = in.readLine();
