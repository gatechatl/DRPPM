...
public class JinghuiZhangGenerateImmuneSignatureSummaryPerSample {
	...
	public static void main(String[] args) {
		try {
			...
			String outputImmuneFile = "\\\\gsc.stjude.org\\project_space\\zhanggrp\\AltSpliceAtlas\\common\\analysis\\ImmuneSignatureAnalysis\\pcgp_immune_ssGSEA_immune_subgroup_annotation.txt";
