 ...
 *
 */
public class JinghuiZhangCombineImmuneScoreWithSCNA {
	...
	public static void main(String[] args) {
		...
		try {
			...
			String outputFile_Disease_Separman = "\\\\gsc.stjude.org\\project_space\\zhanggrp\\AltSpliceAtlas\\common\\analysis\\ImmuneSignatureAnalysis_Updated_Matrix_20200518\\Uncorrected\\SpearmanCorrelMutationBurden\\PCGP_TARGET_SCNA_Table_Disease_Spearman.txt";
			...
			inputFile = "Z:\\ResearchHome\\ProjectSpace\\zhanggrp\\AltSpliceAtlas\\common\\analysis\\PCGP_References\\PCGP_TARGET_SCNA_Table_Prioritized.txt"; 		
				...
				for (String disease: diseases) {
					...
					while (itr.hasNext()) {
						...
						if (sampleName.contains(disease)) {
							...
							scna.add(new Double(scna_count.split("\t")[2]));
