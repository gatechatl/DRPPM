 ...
 *
 */
public class JinghuiZhangProteomicsValidationRNAeditingRMS {
	...
	public static void main(String[] args) {
		...
		try {
			...
			*/
			...
			inputFile = "\\\\gsc.stjude.org\\project_space\\penggrp\\ProteomicsRMS\\common\\HongWangProteomics\\Combined_ID_Peptide\\Combined_ID.txt";
			fstream = new FileInputStream(inputFile);
			din = new DataInputStream(fstream);
			in = new BufferedReader(new InputStreamReader(din));
			while (in.ready()) {
