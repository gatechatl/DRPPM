...
public class JinghuiZhangGenerateRNAeditPeptideFasta {
	...
	public static void main(String[] args) {
		...
		try {
			...
			String conversion_table = "Z:\\ResearchHome\\ProjectSpace\\zhanggrp\\AltSpliceAtlas\\common\\analysis\\RNAediting\\OpenReadingFrame\\GRCh38\\GRCh38_latest_genomic.gtf";
			...
			String outputFile = "\\\\gsc.stjude.org\\project_space\\zhanggrp\\AltSpliceAtlas\\common\\analysis\\RNAediting\\OpenReadingFrame\\RNAeditDatabase.fasta";
			FileWriter fwriter = new FileWriter(outputFile);
			BufferedWriter out = new BufferedWriter(fwriter);
			

			String outputFile_18mer = "\\\\gsc.stjude.org\\project_space\\zhanggrp\\AltSpliceAtlas\\common\\analysis\\RNAediting\\OpenReadingFrame\\RNAedit_18mer.fasta";
			FileWriter fwriter_18mer = new FileWriter(outputFile_18mer);
			BufferedWriter out_18mer = new BufferedWriter(fwriter_18mer);
			

			String outputFile_pit_lookup = "\\\\gsc.stjude.org\\project_space\\zhanggrp\\AltSpliceAtlas\\common\\analysis\\RNAediting\\OpenReadingFrame\\RNAeditDatabase.lookup.txt";
			...
			String outputFile_pit = "\\\\gsc.stjude.org\\project_space\\zhanggrp\\AltSpliceAtlas\\common\\analysis\\RNAediting\\OpenReadingFrame\\RNAeditDatabase.pit";
			FileWriter fwriter_pit = new FileWriter(outputFile_pit);
			BufferedWriter out_pit = new BufferedWriter(fwriter_pit);
			
			String outputFile_peptide = "\\\\gsc.stjude.org\\project_space\\zhanggrp\\AltSpliceAtlas\\common\\analysis\\RNAediting\\OpenReadingFrame\\RNAeditPeptideList.txt";
			...
			String inputFasta = "\\\\gsc.stjude.org\\project_space\\zhanggrp\\AltSpliceAtlas\\common\\analysis\\RNAediting\\OpenReadingFrame\\GRCh38\\GRCh38_latest_protein.faa";
