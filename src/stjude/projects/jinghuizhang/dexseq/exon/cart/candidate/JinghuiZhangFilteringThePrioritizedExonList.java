 ...
 *
 */
public class JinghuiZhangFilteringThePrioritizedExonList {
	...
	public static String parameter_info() {
		return "[pcgp_inputFile] [target_inputFile] [gtex_inputFile_0] [outputFile]";
	}
	public static void execute(String[] args) {
		
		try {
			
			String inputFile = args[0]; //"\\\\gsc.stjude.org\\project_space\\zhanggrp\\AltSpliceAtlas\\common\\analysis\\Comprehensive_CAR-T_Analysis\\hg38_analysis\\AfterLiqingsExonCounting\\Summary\\PCGP_TARGET_GTEx_Candidates.txt";
			String outputFile = args[1]; //"Z:\\ResearchHome\\ProjectSpace\\zhanggrp\\AltSpliceAtlas\\common\\analysis\\Comprehensive_CAR-T_Analysis\\hg38_analysis\\AfterLiqingsExonCounting\\Summary\\PCGP_TARGET_GTEx_Candidates_FilterForOverlapNovelCandidates.txt";
