...
public class McKinnonGCScatterPlot {

	public static String description() {
		return "McKinnon GC Scatter Plot.";
	}
	...
	public static void execute(String[] args) {
		...
		try {
			...
			while (itr.hasNext()) {
				...
				String path = "\\\\\\\\Sjm5vwpfs01.stjude.sjcrh.local\\\\data\\\\ResearchHome\\\\ProjectSpace\\\\mckingrp\\\\HGG\\\\common\\\\TimFiles\\\\McKinnon\\\\YoungdonManuscript\\\\Complete_GC_Scanning\\\\" + geneName + "_1000.fasta.ScannerResult.txt";
				String test_path = "Complete_GC_Scanning/" + geneName + "_1000.fasta.ScannerResult.txt";
				File f = new File(test_path);
				if (f.exists()) {
					out.write("data = read.table(\"" + path + "\", sep=\"\\t\",header=T)\n");
					out.write("tiff(filename = \"\\\\\\\\Sjm5vwpfs01.stjude.sjcrh.local\\\\data\\\\ResearchHome\\\\ProjectSpace\\\\mckingrp\\\\HGG\\\\common\\\\TimFiles\\\\McKinnon\\\\YoungdonManuscript\\\\Complete_GC_Scanning_Images\\\\" + geneName + "_1000_ScannerResult.txt.tif\",res=300, width=1600, height=1200)\n");
