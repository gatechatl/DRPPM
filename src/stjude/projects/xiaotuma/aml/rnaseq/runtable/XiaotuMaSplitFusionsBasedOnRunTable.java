...
public class XiaotuMaSplitFusionsBasedOnRunTable {
	...
	public static void main(String[] args) {
		...
		try {
			...
			String outputFile1 = "\\\\gsc.stjude.org\\project_space\\xmagrp\\AMLRelapse\\common\\FredHutch\\fusion\\Tim_Manual_Checking\\CICERO_Fusion_Group1.txt";
			FileWriter fwriter1 = new FileWriter(outputFile1);
			BufferedWriter out1 = new BufferedWriter(fwriter1);
			
			String outputFile2 = "\\\\gsc.stjude.org\\project_space\\xmagrp\\AMLRelapse\\common\\FredHutch\\fusion\\Tim_Manual_Checking\\CICERO_Fusion_Group2.txt";
			FileWriter fwriter2 = new FileWriter(outputFile2);
			BufferedWriter out2 = new BufferedWriter(fwriter2);
			
			String outputFile3 = "\\\\gsc.stjude.org\\project_space\\xmagrp\\AMLRelapse\\common\\FredHutch\\fusion\\Tim_Manual_Checking\\CICERO_Fusion_Group3.txt";
			FileWriter fwriter3 = new FileWriter(outputFile3);
			BufferedWriter out3 = new BufferedWriter(fwriter3);
			
			String outputFile4 = "\\\\gsc.stjude.org\\project_space\\xmagrp\\AMLRelapse\\common\\FredHutch\\fusion\\Tim_Manual_Checking\\CICERO_Fusion_Group4.txt";
			FileWriter fwriter4 = new FileWriter(outputFile4);
			BufferedWriter out4 = new BufferedWriter(fwriter4);
			
			String outputFile5 = "\\\\gsc.stjude.org\\project_space\\xmagrp\\AMLRelapse\\common\\FredHutch\\fusion\\Tim_Manual_Checking\\CICERO_Fusion_Group5.txt";
