...
public class XiaotuMaCompileFusionListLQ {
		...
		try {
			...
			while (in.ready()) {
				...
				if (split.length > 9) {
					...
					String type = split[9];
					String fusion_name = geneA + ";" +  geneB + ";" + type + ";" + split[12];	
					//if (rating.equals("LQ")) {
						if (!sample_fusion.containsKey(sampleName + ";" + geneA + ";" + geneB + ";" + type + ";" + rating)) {
					...
					//}
					sample_fusion.put(sampleName + ";" + geneA + ";" + geneB + ";" + type + ";" + rating, "");
					String usage = split[11];
					String line = geneA + ";" + geneB + ";" + type + ";" + rating;
			...
			String outputFile = "\\\\gsc.stjude.org\\project_space\\xmagrp\\AMLRelapse\\common\\FredHutch\\fusion\\Tim_Compile_Fusion_List\\PutativeList_LQ_20200106.txt";
			...
			String outputRecurrentFile = "\\\\gsc.stjude.org\\project_space\\xmagrp\\AMLRelapse\\common\\FredHutch\\fusion\\Tim_Compile_Fusion_List\\Recurrent_Fusion_List_LQ_20200106.txt";
