...
/**
 * Annotate the events with different types of candidates: recurrent or potential interesting events. 
 * @author tshaw
 *
 */
public class XiaotuAppendTimAnnotationBamViewerLinksUpdate {
	public static String description() {
		return "Annotate the CICERO results with putative drivers for each sample";
	}
	public static String type() {
		return "RNASEQ";
	}
	public static String parameter_info() {
		return "[inputRecurrentFile] [inputFileCiceroOutput] [outputUpdatedCiceroFile]";
	}
	public static void execute(String[] args) {
		try {
			
			String inputRecurrentFile = args[0]; //"\\\\gsc.stjude.org\\project_space\\xmagrp\\AMLRelapse\\common\\FredHutch\\fusion\\Tim_Compile_Fusion_List\\Recurrent_Fusion_List_20200217.txt";
			String inputFileCiceroOutput = args[1]; //"\\\\gsc.stjude.org\\project_space\\xmagrp\\AMLRelapse\\common\\FredHutch\\fusion\\fus_20200217.txt";
			String outputUpdatedCiceroFile = args[2]; //\\\\gsc.stjude.org\\project_space\\xmagrp\\AMLRelapse\\common\\FredHutch\\fusion\\Tim_Compile_Fusion_List\\20200217\\fus_tim_updated_20200217.txt";
			//String outputUpdatedCiceroFile = "\\\\gsc.stjude.org\\project_space\\xmagrp\\AMLRelapse\\common\\FredHutch\\fusion\\Tim_Compile_Fusion_List\\20200203\\fus_tim_updated_20200203.txt";
			...
			FileInputStream fstream = new FileInputStream(inputRecurrentFile);
