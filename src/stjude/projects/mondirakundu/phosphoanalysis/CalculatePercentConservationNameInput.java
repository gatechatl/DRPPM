 ...
 *
 */
public class CalculatePercentConservationNameInput {
	...
	public static String parameter_info() {
		return "[alignmentFile] [nameInput] [posFile] [path] [outputFileSummary]";
	}
	public static void execute(String[] args) {
		try {
			...
			String name = args[1];
			String posFile = args[2]; //"C:\\Users\\tshaw\\Desktop\\PROTEOMICS\\Projects\\Kundu\\Conservation\\SEC16a_candidate_list.txt";
			String path = args[3]; //"C:\\Users\\tshaw\\Desktop\\PROTEOMICS\\Projects\\Kundu\\Conservation\\SEC16A_Sites\\";
			String outputFileSummary = args[4];
			...
			while (in.ready()) {
				...
				if (str.contains(">")) {
					...
					if (temp.contains(name)) {
						...
						System.out.println("Found target reference in alignment: " + humanGeneName);
					}
				}
			}
			in.close();
			...
			while (itr.hasNext()) {
				...
				out2.write(str + "\t" + absolute_conservation_vertebrate + "\t" + phospho_conservation_vertebrate + "\n");
	...
	public static String phospho_conservation_invertebrate(HashMap pos_map, int i) {
		...
		//if (pos_map.containsKey(i)) {
			...
			System.out.println("Grab: " + i + "\t" + total);
			String result = "";
