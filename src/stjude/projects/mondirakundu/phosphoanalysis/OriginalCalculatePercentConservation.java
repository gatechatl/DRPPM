...
public class OriginalCalculatePercentConservation {
	...
	public static void main(String[] args) {
		try {
			...
			String posFile = "C:\\Users\\tshaw\\Desktop\\PROTEOMICS\\Projects\\Kundu\\Conservation\\SEC16a_candidate_list.txt";
			String path = "C:\\Users\\tshaw\\Desktop\\PROTEOMICS\\Projects\\Kundu\\Conservation\\SEC16A_Sites\\";
			...
			while (itr.hasNext()) {
				...
				int i = getPosition(loc, pos_map, "Sec16A_Homo_sapiens");
